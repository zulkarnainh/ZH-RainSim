...
This tool simplifies the process of simulating daily rainfall series for hydrological and hydraulic impact assessments under various climate scenarios (e.g., SSP5-8.5).
...
4.  Run `ZH-RainSim.exe`.

> **Note:** No installation is required. This is a portable application.
...
* **User-Friendly Interface:** Graphical User Interface (GUI) designed for researchers.
* **Data Visualization:** Built-in plotting for immediate analysis of results.
